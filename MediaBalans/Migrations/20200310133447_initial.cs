        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ConnectedUsers_AspNetUsers_FollowingId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAtTime = table.Column<DateTime>(nullable: false),
                    UpdatedAtTime = table.Column<DateTime>(nullable: false),
                    DeletedAtTime = table.Column<DateTime>(nullable: false),
                    CustomUserId = table.Column<string>(nullable: true),
                    PostContent = table.Column<string>(maxLength: 2500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeletedAtTime = table.Column<DateTime>(nullable: false),
                    CustomUserId = table.Column<string>(nullable: true),
                    ComContent = table.Column<string>(maxLength: 2500, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConnectedUsers_FollowingId",
